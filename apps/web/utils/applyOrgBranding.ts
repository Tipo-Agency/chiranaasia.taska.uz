...
export function applyOrgBrandingToDocument(data: OrgBrandingDto | null | undefined): void {
  ...
  const favFill = c ?? '#F97316';
  applyOrgFaviconToDocument(favFill);
}
