...
export const LoginPage: React.FC<LoginPageProps> = ({ users, onLogin, onShowLoginForm }) => {
  const handleEnter = () => {
    const user = users[0];
      ...
      <Card className="w-full p-8">
        ...
        {onShowLoginForm && (
          <button
            ...
            className="mt-4 w-full text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 underline-offset-4 hover:underline"
          >
