            ...
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="bg-white dark:bg-[#252525] p-8 rounded-2xl shadow-xl border border-gray-200 dark:border-[#333]">
                    ...
                    <div className="space-y-5">
                        ...
                        <button 
                            type="submit" 
                            className="w-full bg-[#3337AD] hover:bg-[#292b8a] text-white font-semibold py-3 rounded-lg transition-colors shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#3337AD] focus:ring-offset-2"
                        >
                            Войти
                        </button>
                    </div>
