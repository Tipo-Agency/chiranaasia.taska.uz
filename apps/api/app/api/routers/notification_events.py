...
from app.schemas.notification_events import DomainEventIn, DomainEventOut, DomainEventRecentRead
from app.services.domain_events import emit_domain_event
from app.core.auth import get_current_user

router = APIRouter(prefix="/notification-events", tags=["notification-events"], dependencies=[Depends(get_current_user)])
...
@router.get("/recent", response_model=list[DomainEventRecentRead])
