...
| [modules/messages.md](./modules/messages.md)           | Бизнес-правила Messages: Inbox/Outbox, дедупликация               | Актуален                                                             |
| [modules/integrations.md](./modules/integrations.md)   | Бизнес-правила Integrations: Telegram, Meta, Сайт, MTProto        | Актуален                                                             |
