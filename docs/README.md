# chiranaasia.taska.uz — Документация
...
**chiranaasia.taska.uz** — корпоративный рабочий стол для команд 10–200 человек. Объединяет трекер задач, CRM с диалогами из Telegram/Instagram, финансы, HR, внутренний чат и интеграции с мессенджерами в одном веб-приложении.
